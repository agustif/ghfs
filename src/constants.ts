...
export const ACTIVITY_FILE_NAME = 'activity.md'
export const CODEOWNERS_ERRORS_FILE_NAME = 'constitution/CODEOWNERS.errors.json'
export const LANGUAGES_FILE_NAME = 'languages.json'
