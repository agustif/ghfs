...
export const RELEASES_INDEX_FILE_NAME = 'releases.md'
export const PACKAGES_INDEX_FILE_NAME = 'packages.md'
...
export const ENHANCED_GRAPH_FILE_NAME = 'graph.json'
export const AGENT_HINTS_FILE_NAME = 'agent-hints.md'
export const LABELS_FILE_NAME = 'labels.json'
export const MILESTONES_FILE_NAME = 'milestones.json'
export const RELEASES_FILE_NAME = 'releases.json'
export const RULESETS_DIR_NAME = 'rulesets'
export const RULESETS_FILE_NAME = 'rulesets.json'
export const CONSTITUTION_DIR_NAME = 'constitution'
export const ACTIONS_DIR_NAME = 'actions'
export const ACTIONS_FILE_NAME = 'recent-runs.json'
export const ACTIONS_INDEX_FILE_NAME = 'actions.md'
export const GIT_DIR_NAME = 'git'
export const GIT_COMMITS_DIR_NAME = 'commits'
export const GIT_TREE_HEAD_FILE_NAME = 'head-tree.json'
export const GIT_REFS_FILE_NAME = 'refs.json'
...
export const COMMIT_COMMENTS_FILE_NAME = 'commit-comments.jsonl'
export const REPO_INVITATIONS_FILE_NAME = 'invitations.json'
export const VIEWER_STATUS_FILE_NAME = 'viewer-status.json'
export const REPO_TEMPLATE_FILE_NAME = 'template.json'
export const FORK_STATUS_FILE_NAME = 'fork-status.json'
export const NETWORK_SUMMARY_FILE_NAME = 'network-summary.json'
export const ACTIVITY_EVENTS_FILE_NAME = 'activity.jsonl'
export const FEEDS_FILE_NAME = 'feeds.json'
