  ...
  return {
    ...
    config: {
      ...
      sync: {
        ...
        stargazers: syncOverrides.stargazers ?? true,
        watchers: syncOverrides.watchers ?? true,
        forks: syncOverrides.forks ?? true,
        traffic: syncOverrides.traffic ?? true,
        contributors: syncOverrides.contributors ?? true,
      },
    },
    syncState: {
      version: 2,
