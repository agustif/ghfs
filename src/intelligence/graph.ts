...
export async function buildGraph(storageDir: string): Promise<Graph> {
  // Stub: return empty graph
  return { nodes: [], edges: [] }
}

export async function addGraphNode(storageDir: string, node: GraphNode): Promise<void> {
  // TODO: Append node to graph.jsonl
}

export async function addGraphEdge(storageDir: string, edge: GraphEdge): Promise<void> {
  // TODO: Append edge to graph.jsonl
}

export async function loadGraph(storageDir: string): Promise<Graph> {
  // TODO: Load and parse .ghfs/graph.jsonl
  return { nodes: [], edges: [] }
}

export async function writeGraph(storageDir: string, graph: Graph): Promise<void> {
